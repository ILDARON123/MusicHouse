...
function getFilters()
{
    $wheres = [
        "types" => "Тип товара",
        "countries" => "Старана-производитель"
    ];
    $sortByMany = [
...
?>
    <form id="filters" class="btns g10 p10">
        ...
        ?>
            <select name="<?= $concat ?>" class="block p10 brad10 accent-to-black">
        ...
        ?>
        <select id="order_by" name="order_by" class="block p10 brad10 accent-to-black">
        ...
        <button class="radius p10 brad10 accent-to-black">Применить</button>
        <button><a href="?" class="radius p10 brad10 accent-to-black">Сброс</a></button>
    </form>
<?php
}
